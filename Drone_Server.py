...
right_motor_less_pwm_percent = 0.675 # change to make motors go at same speed, right motor turns at (1-right_motor_less_pwm_percent)% of left motor
max_left_pwm = 1000
max_right_pwm = 1000*right_motor_less_pwm_percent
