...
right_motor_less_pwm_percent = 0.50
max_left_pwm = int((1500.0 / (1 - right_motor_less_pwm_percent)) / less_turn_percent)
max_right_pwm = int(max_left_pwm * (1 - right_motor_less_pwm_percent))
